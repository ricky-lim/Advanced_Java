...
public class CollectionsDemo {
    private List<Integer> nums = Arrays.asList(3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3, 2, 3,
            8, 4, 6, 2, 6, 4, 3, 3);
    ...
    public static void main(String[] args) {
        ...
        demo.printNums(demo.doubleWithSleep);
        end = System.nanoTime();
        System.out.println("Time taken with sleep : " + (end - start) / 1e9);

        start = System.nanoTime();
        demo.printNumsParallel(demo.doubleWithSleep);
        end = System.nanoTime();
        System.out.println("Time taken with sleep with parallel : " + (end - start) / 1e9);
